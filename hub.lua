...
local SERVERS = {
    ...
    "Scourge", "Sentinel", "Shade", "Sierra", "Tango", "Tempest", "Torment", "Ulcer", "Unholy", "Uniform"
}

local FILENAME = "scanned_servers.txt"

local function loadScanned()
...
local function saveScanned(data)
    if writefile then
